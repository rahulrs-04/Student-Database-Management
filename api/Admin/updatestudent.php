...
<div class="glass-container" style="max-width: 900px; margin-top: 1rem;">
    <h2 style="text-align: center; margin-bottom: 2rem; background: linear-gradient(135deg, #fff 30%, var(--primary)); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Update Student Records</h2>
    
    <form action="updatestudent.php" method="post" style="display: flex; gap: 1rem; align-items: flex-end; flex-wrap: wrap; margin-bottom: 2rem;">
        ...
        <div style="flex: 0; min-width: 120px;">
            <input type="submit" name="submit" class="btn-submit" value="Search" style="padding: 0.75rem 1.5rem;" />
        </div>
    </form>
                    ...
                    <tbody>
                        ...
                        foreach($records as $data){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="updateform.php?sid=<?php echo $data['id']; ?>" class="action-link link-edit">Edit</a>
                                </td>
                            </tr>
                            <?php
                        }
